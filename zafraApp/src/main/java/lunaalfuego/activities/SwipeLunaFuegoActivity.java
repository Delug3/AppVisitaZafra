...
import lunaalfuego.adapters.PagerFotosLunaFuegoAdapter;


public class SwipeLunaFuegoActivity extends AppCompatActivity {
	
	private long id;	
	private ViewPager viewPager;
	private PagerFotosLunaFuegoAdapter lfAdapter;
	...
	lfAdapter = new PagerFotosLunaFuegoAdapter(getSupportFragmentManager(),bundle);
