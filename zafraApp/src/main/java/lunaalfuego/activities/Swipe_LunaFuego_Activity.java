...
import lunaalfuego.adapters.Pager_Fotos_LunaFuego_Adapter;


public class Swipe_LunaFuego_Activity extends AppCompatActivity {
	
	private long id;	
	private ViewPager viewPager;
	private Pager_Fotos_LunaFuego_Adapter lfAdapter;
	...
	lfAdapter = new Pager_Fotos_LunaFuego_Adapter(getSupportFragmentManager(),bundle);
