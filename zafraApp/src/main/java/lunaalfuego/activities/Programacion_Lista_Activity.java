...
import feriazafra.activities.Info_Detalle_Programacion_Activity;


public class Programacion_Lista_Activity extends Activity {
	...
	public void evento_Dia_20(View v)
	 {
		 Intent act =new Intent(this, Info_Detalle_Programacion_Activity.class);
