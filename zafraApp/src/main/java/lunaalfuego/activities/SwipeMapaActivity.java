...
import lunaalfuego.adapters.PagerMapaAdapter;

//NO HACIA FALTA,modificar y asignar extension viewpager y listo!!(para plano)
public class SwipeMapaActivity extends AppCompatActivity {
	
	private long id;	
	private ViewPager viewPager;
	private PagerMapaAdapter lfAdapter;
	...
	lfAdapter = new PagerMapaAdapter(getSupportFragmentManager(),bundle);
