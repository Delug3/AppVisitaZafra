...
import lunaalfuego.adapters.Pager_Mapa_Adapter;

//NO HACIA FALTA,modificar y asignar extension viewpager y listo!!(para plano)
public class Swipe_Mapa_Activity extends AppCompatActivity {
	
	private long id;	
	private ViewPager viewPager;
	private Pager_Mapa_Adapter lfAdapter;
	...
	lfAdapter = new Pager_Mapa_Adapter(getSupportFragmentManager(),bundle);
