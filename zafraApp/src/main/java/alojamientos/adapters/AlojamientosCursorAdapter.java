...
public class AlojamientosCursorAdapter extends CursorAdapter{
	private AlojamientosDbAdapter Db_Adapter = null ;
	 
	   @SuppressWarnings("deprecation")
	   public AlojamientosCursorAdapter(Context context, Cursor c)
	   {
	      super(context, c);
	   ...
	   tv.setText(cursor.getString(cursor.getColumnIndex(AlojamientosDbAdapter.C_ALO_COLUMNA_NOMBRE)));
	   tv.setTextSize(20);  
	   String uri = cursor.getString(cursor.getColumnIndex(AlojamientosDbAdapter.C_ALO_COLUMNA_ICONOIMAGEN));
	   ...
	   String uri2 = cursor.getString(cursor.getColumnIndex(AlojamientosDbAdapter.C_ALO_COLUMNA_ESTRELLAFOTO));
