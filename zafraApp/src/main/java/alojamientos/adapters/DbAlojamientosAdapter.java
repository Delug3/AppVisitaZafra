...
public class DbAlojamientosAdapter {
	 /**
	   ...
	   public DbAlojamientosAdapter(Context context)
	   {
	      this.contexto = context;
	   }
	 
	   public DbAlojamientosAdapter abrir() throws SQLException
	   {
		  db_Helper = DbHelper.getInstance(contexto);
