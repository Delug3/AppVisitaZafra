...
import alojamientos.adapters.AlojamientosCursorAdapter;
import alojamientos.adapters.AlojamientosDbAdapter;
import ayto.zafrApp.R;


public class Alojamientos_Lista_Activity extends ListActivity {
...
private void consultarRural()
   ...
   private void visualizar(long id)
	   {
	      Intent i = new Intent(Alojamientos_Lista_Activity.this, Alojamientos_TabSwipe_Activity.class);
