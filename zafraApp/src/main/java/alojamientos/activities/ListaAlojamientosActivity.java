...
import alojamientos.adapters.CursorAlojamientosAdapter;
import alojamientos.adapters.DbAlojamientosAdapter;
import ayto.zafrApp.R;


public class ListaAlojamientosActivity extends ListActivity {
	private DbAlojamientosAdapter Db_Adapter;
    private Cursor cursor;
    private CursorAlojamientosAdapter alojamientos_Adapter ;
   ...
   private void consultarHoteles()
   {
      ...
      alojamientos_Adapter = new CursorAlojamientosAdapter(this, cursor);
...
private void consultarRural()
   ...
   private void visualizar(long id)
	   {
	      Intent i = new Intent(ListaAlojamientosActivity.this, TabSwipeAlojamientosActivity.class);
	      i.putExtra(DbAlojamientosAdapter.C_ALO_COLUMNA_ID, id);
