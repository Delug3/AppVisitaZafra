...
public class Fotos_FeriaZafra_Fragment extends Fragment {
	
	   
@Override
public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
   final View rootView = inflater.inflate(R.layout.feriazafra_galeria, container, false);
   
    Integer imgArra[]={R.drawable.res_feria_galeria1,R.drawable.res_feria_galeria2,R.drawable.res_feria_galeria3,R.drawable.res_feria_galeria4,R.drawable.res_feria_galeria5,R.drawable.res_feria_galeria6,R.drawable.res_feria_galeria7,R.drawable.res_feria_galeria8};
