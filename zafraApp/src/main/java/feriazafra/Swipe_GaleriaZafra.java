...
public class Swipe_GaleriaZafra extends AppCompatActivity {
	
	private long id;	
	private ViewPager viewPager;
	private Pager_Fotos_FeriaZafra lfAdapter;
	...
	lfAdapter = new Pager_Fotos_FeriaZafra(getSupportFragmentManager(),bundle);
