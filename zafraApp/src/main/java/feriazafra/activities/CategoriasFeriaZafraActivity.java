...
import rss_feria.activities.RssNoticiasFeriaActivity;
...
public class CategoriasFeriaZafraActivity extends Activity{
	...
	public void verNoticiasFeria(View v)
	 {
		 if (existeConexionInternet()){
				Intent act = new Intent(this, RssNoticiasFeriaActivity.class);
				startActivity(act);
				}else{
	...
	public void verExpositoresFeria_Lista(View v)
	 {
		 Intent act =new Intent(this, ListaExpositoresActivity.class);
		 startActivity(act);
	 }
	
	public void verPlanoFeria(View v)
	 {
		Intent act =new Intent(this, PlanoFeriaActivity.class);
		startActivity(act);
	 }
	
	public void verGaleriaFotosFeria(View v)
	 {
		Intent act =new Intent(this, SwipeGaleriaZafraActivity.class);
		startActivity(act);
	 }
	
	public void InformacionInteresFeria(View v)
	 {
		Intent act =new Intent(this, InformacionInteresActivity.class);
		startActivity(act);
	 }
