...
import feriazafra.adapters.Pager_Fotos_FeriaZafra_Adapter;

public class Swipe_GaleriaZafra_Activity extends AppCompatActivity {
	
	private long id;	
	private ViewPager viewPager;
	private Pager_Fotos_FeriaZafra_Adapter lfAdapter;
	...
	lfAdapter = new Pager_Fotos_FeriaZafra_Adapter(getSupportFragmentManager(),bundle);
