...
public class Restaurantes_TabSwipe extends AppCompatActivity implements
ActionBar.TabListener {
	 SlidingPaneLayout pane;
	    ...
	    private TabsPager_Restaurantes mAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        */
		...
		if (extra.containsKey(RestaurantesDbAdapter.C_RES_COLUMNA_ID))
		{
			id = extra.getLong(RestaurantesDbAdapter.C_RES_COLUMNA_ID);
		}
		...
		mAdapter = new TabsPager_Restaurantes(getSupportFragmentManager(),bundle);
...
viewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
	...
	/*public void AbrirMonumentos()
	{
		   Intent main = new Intent(this, MenuPrincipal.class);
		    ...
		    Intent actual = new Intent(this, Monumentos_Lista.class);
...
public boolean onOptionsItemSelected(MenuItem item){
	...
	String titulo=(cursor.getString(cursor.getColumnIndex(RestaurantesDbAdapter.C_RES_COLUMNA_NOMBRE)));
...
public void VerGPS(View v)
{
	...
	{
	cursor = Db_Adapter.getRegistro(id);
   final Double latgps = cursor.getDouble(cursor.getColumnIndex(RestaurantesDbAdapter.C_RES_COLUMNA_GPSLATITUD));
   final Double longps = cursor.getDouble(cursor.getColumnIndex(RestaurantesDbAdapter.C_RES_COLUMNA_GPSLONGITUD));
