...
public class InicioRestaurantesFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
	     ...
	     Db_Adapter = new DbRestaurantesAdapter(context);
	     Db_Adapter.abrir();
	     cursor = Db_Adapter.getRegistro(identificador);
        
         nombre.setText(cursor.getString(cursor.getColumnIndex(DbRestaurantesAdapter.C_RES_COLUMNA_NOMBRE)));
         telefono.setText(cursor.getString(cursor.getColumnIndex(DbRestaurantesAdapter.C_RES_COLUMNA_TELEFONO)));
         direccion.setText(cursor.getString(cursor.getColumnIndex(DbRestaurantesAdapter.C_RES_COLUMNA_DIRECCION)));
         email.setText(cursor.getString(cursor.getColumnIndex(DbRestaurantesAdapter.C_RES_COLUMNA_EMAIL)));
         web.setText(cursor.getString(cursor.getColumnIndex(DbRestaurantesAdapter.C_RES_COLUMNA_WEB)));
       
         String uri = cursor.getString(cursor.getColumnIndex(DbRestaurantesAdapter.C_RES_COLUMNA_INICIOIMAGEN));
