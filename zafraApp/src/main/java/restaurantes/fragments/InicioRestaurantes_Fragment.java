...
public class InicioRestaurantes_Fragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
         ...
         nombre.setText(cursor.getString(cursor.getColumnIndex(RestaurantesDb_Adapter.C_RES_COLUMNA_NOMBRE)));
         telefono.setText(cursor.getString(cursor.getColumnIndex(RestaurantesDb_Adapter.C_RES_COLUMNA_TELEFONO)));
         direccion.setText(cursor.getString(cursor.getColumnIndex(RestaurantesDb_Adapter.C_RES_COLUMNA_DIRECCION)));
         email.setText(cursor.getString(cursor.getColumnIndex(RestaurantesDb_Adapter.C_RES_COLUMNA_EMAIL)));
         web.setText(cursor.getString(cursor.getColumnIndex(RestaurantesDb_Adapter.C_RES_COLUMNA_WEB)));
       
         String uri = cursor.getString(cursor.getColumnIndex(RestaurantesDb_Adapter.C_RES_COLUMNA_INICIOIMAGEN));
