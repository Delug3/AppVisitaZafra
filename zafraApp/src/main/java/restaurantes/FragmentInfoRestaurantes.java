...
public class FragmentInfoRestaurantes extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        labelinfo.setText(cursor.getString(cursor.getColumnIndex(RestaurantesDbAdapter.C_RES_COLUMNA_NOMBRE)));
        String jtext=(cursor.getString(cursor.getColumnIndex(RestaurantesDbAdapter.C_RES_COLUMNA_INFORMACION)));
        String text;
