...
public class CursorRestaurantesAdapter extends CursorAdapter
{
 private DbRestaurantesAdapter Db_Adapter = null ;
 
 
   @SuppressWarnings("deprecation")
   public CursorRestaurantesAdapter(Context context, Cursor c)
   {
      super(context, c);
   ...
   tv.setText(cursor.getString(cursor.getColumnIndex(DbRestaurantesAdapter.C_RES_COLUMNA_NOMBRE)));
   tv.setTextSize(20);  
   String uri = cursor.getString(cursor.getColumnIndex(DbRestaurantesAdapter.C_RES_COLUMNA_ICONOIMAGEN));
