...
public class RestaurantesCursor_Adapter extends CursorAdapter
{
 private RestaurantesDb_Adapter Db_Adapter = null ;
 
 
   @SuppressWarnings("deprecation")
   public RestaurantesCursor_Adapter(Context context, Cursor c)
   {
      super(context, c);
   ...
   tv.setText(cursor.getString(cursor.getColumnIndex(RestaurantesDb_Adapter.C_RES_COLUMNA_NOMBRE)));
   tv.setTextSize(20);  
   String uri = cursor.getString(cursor.getColumnIndex(RestaurantesDb_Adapter.C_RES_COLUMNA_ICONOIMAGEN));
