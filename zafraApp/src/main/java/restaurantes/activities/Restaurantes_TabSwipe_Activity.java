...
import restaurantes.adapters.TabsPager_Restaurantes_Adapter;

public class Restaurantes_TabSwipe_Activity extends AppCompatActivity implements
ActionBar.TabListener {
	 SlidingPaneLayout pane;
	    ...
	    private TabsPager_Restaurantes_Adapter mAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        */
		...
		if (extra.containsKey(RestaurantesDb_Adapter.C_RES_COLUMNA_ID))
		{
			id = extra.getLong(RestaurantesDb_Adapter.C_RES_COLUMNA_ID);
		}
		...
		mAdapter = new TabsPager_Restaurantes_Adapter(getSupportFragmentManager(),bundle);
...
viewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
	...
	{
		   Intent main = new Intent(this, MenuPrincipal.class);
		    main.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP
		        | Intent.FLAG_ACTIVITY_NEW_TASK);
		    startActivity(main);

		    Intent actual = new Intent(this, Monumentos_Lista_Activity.class);
...
public boolean onOptionsItemSelected(MenuItem item){
	...
	String titulo=(cursor.getString(cursor.getColumnIndex(RestaurantesDb_Adapter.C_RES_COLUMNA_NOMBRE)));
...
public void VerGPS(View v)
{
	...
	{
	cursor = Db_Adapter.getRegistro(id);
   final Double latgps = cursor.getDouble(cursor.getColumnIndex(RestaurantesDb_Adapter.C_RES_COLUMNA_GPSLATITUD));
   final Double longps = cursor.getDouble(cursor.getColumnIndex(RestaurantesDb_Adapter.C_RES_COLUMNA_GPSLONGITUD));
