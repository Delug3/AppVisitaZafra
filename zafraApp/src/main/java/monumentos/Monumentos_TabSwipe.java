...
public class Monumentos_TabSwipe extends AppCompatActivity implements ActionBar.TabListener {
	SlidingPaneLayout pane;
	private MonumentosDbAdapter Db_Adapter;
	private Cursor cursor;
	private long id;	
	private ViewPager viewPager;
	private TabsPager_Monumentos mAdapter;
	...
	if (extra.containsKey(MonumentosDbAdapter.C_MON_COLUMNA_ID))
	{
	   id = extra.getLong(MonumentosDbAdapter.C_MON_COLUMNA_ID);
	}
	...
	mAdapter = new TabsPager_Monumentos(getSupportFragmentManager(),bundle);
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		String titulo=(cursor.getString(cursor.getColumnIndex(MonumentosDbAdapter.C_MON_COLUMNA_NOMBRE)));
	...
	public void VerGPS(View v)
	{
		...
		cursor = Db_Adapter.getRegistro(id);
	    final Double latgps = cursor.getDouble(cursor.getColumnIndex(MonumentosDbAdapter.C_MON_COLUMNA_GPSLATITUD));
	    final Double longps = cursor.getDouble(cursor.getColumnIndex(MonumentosDbAdapter.C_MON_COLUMNA_GPSLONGITUD));
