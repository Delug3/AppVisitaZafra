...
public class InfoMonumentos_Fragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        labelinfo.setText(cursor.getString(cursor.getColumnIndex(MonumentosDb_Adapter.C_MON_COLUMNA_NOMBRE)));
        //informacion.setText(cursor.getString(cursor.getColumnIndex(MonumentosDb_Adapter.C_MON_COLUMNA_INFORMACION)));
       
        String jtext=(cursor.getString(cursor.getColumnIndex(MonumentosDb_Adapter.C_MON_COLUMNA_INFORMACION)));
        String text;
