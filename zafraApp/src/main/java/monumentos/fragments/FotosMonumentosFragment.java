...
public class FotosMonumentosFragment extends Fragment {
...
public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
   ...
   String uri1 = cursor.getString(cursor.getColumnIndex(DbMonumentosAdapter.C_MON_COLUMNA_FOTO1));
   int Idfoto1 = this.getResources().getIdentifier(uri1,null,getActivity().getPackageName());
   String uri2 = cursor.getString(cursor.getColumnIndex(DbMonumentosAdapter.C_MON_COLUMNA_FOTO2));
   int Idfoto2 = this.getResources().getIdentifier(uri2,null,getActivity().getPackageName());
   String uri3 = cursor.getString(cursor.getColumnIndex(DbMonumentosAdapter.C_MON_COLUMNA_FOTO3));
   int Idfoto3 = this.getResources().getIdentifier(uri3,null,getActivity().getPackageName());
   String uri4 = cursor.getString(cursor.getColumnIndex(DbMonumentosAdapter.C_MON_COLUMNA_FOTO4));
