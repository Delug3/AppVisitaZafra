...
public class FragmentInicioMonumentos extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
       ...
       nombre.setText(cursor.getString(cursor.getColumnIndex(MonumentosDbAdapter.C_MON_COLUMNA_NOMBRE)));
       telefono.setText(cursor.getString(cursor.getColumnIndex(MonumentosDbAdapter.C_MON_COLUMNA_TELEFONO)));
       direccion.setText(cursor.getString(cursor.getColumnIndex(MonumentosDbAdapter.C_MON_COLUMNA_DIRECCION)));
       horario.setText(cursor.getString(cursor.getColumnIndex(MonumentosDbAdapter.C_MON_COLUMNA_HORARIO)));
       String vacio=(cursor.getString(cursor.getColumnIndex(MonumentosDbAdapter.C_MON_COLUMNA_HORARIO)));
     ...
     //ocultar tag del horario si no esta disponible
       ...
       String uri = cursor.getString(cursor.getColumnIndex(MonumentosDbAdapter.C_MON_COLUMNA_INICIOIMAGEN));
