...
import monumentos.adapters.TabsPager_Monumentos_Adapter;

public class Monumentos_TabSwipe_Activity extends AppCompatActivity implements ActionBar.TabListener {
	SlidingPaneLayout pane;
	private MonumentosDb_Adapter Db_Adapter;
	private Cursor cursor;
	private long id;	
	private ViewPager viewPager;
	private TabsPager_Monumentos_Adapter mAdapter;
	...
	if (extra.containsKey(MonumentosDb_Adapter.C_MON_COLUMNA_ID))
	{
	   id = extra.getLong(MonumentosDb_Adapter.C_MON_COLUMNA_ID);
	}
	...
	mAdapter = new TabsPager_Monumentos_Adapter(getSupportFragmentManager(),bundle);
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		String titulo=(cursor.getString(cursor.getColumnIndex(MonumentosDb_Adapter.C_MON_COLUMNA_NOMBRE)));
	...
	public void VerGPS(View v)
	{
		...
		cursor = Db_Adapter.getRegistro(id);
	    final Double latgps = cursor.getDouble(cursor.getColumnIndex(MonumentosDb_Adapter.C_MON_COLUMNA_GPSLATITUD));
	    final Double longps = cursor.getDouble(cursor.getColumnIndex(MonumentosDb_Adapter.C_MON_COLUMNA_GPSLONGITUD));
